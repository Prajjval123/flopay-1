(function (EXPORTS) { //floBlockchainAPI v3.1.3
    ...
    const checkIfTor = floBlockchainAPI.checkIfTor = async () => {
        return fetch('https://proxy.cors.sh/https://api.ipify.org?format=json', {
            headers: {
                'x-cors-api-key': 'temp_997ad90de66e7fc612e78aba2b915433'
            }
